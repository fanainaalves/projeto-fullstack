...
export class ShoppingCardComponent {
  ...
  onclickAdd(product: any) {
    ...
    if (cartProduct) {
      ...
      let totalCart = (product.price - (product.price * product.discount / 100)) * product.quantity;
    }
  }
  ...
  totalProd(product: Product) {
    let totalproduto = (product.price - (product.price * product.discount / 100)) * product.quantity;
    return totalproduto;
  }
